...
export default registerBlockType( 'give/donation-form-grid', {
	...
	description: __( 'The Best Donation Donation Form Grid block insert an existing donation form into the page. Each form\'s presentation can be customized below.', 'give' ),
	category: 'give',
