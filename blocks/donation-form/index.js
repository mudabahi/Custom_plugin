...
export default registerBlockType( 'give/donation-form', {
	...
	description: __( 'The Best Donation Donation Form block inserts an existing donation form into the page. Each donation form\'s presentation can be customized below.', 'give' ),
	category: 'give',
