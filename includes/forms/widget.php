...
class Give_Forms_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct(
			...
			esc_html__( 'Beste Spende – Spendenformular', 'give' ),
			[
				'description' => esc_html__( 'Zeigen Sie in der Widget-Seitenleiste Ihres Themes ein Formular für die beste Spende an.', 'give' ),
			]
		);
