...
class Give_MetaBox_Form_Data {
	...
	function __construct() {
		...
		$this->metabox_label = __( 'Optionen für Spendenformulare', 'give' );
		...
		$settings = [
				...
				[
					...
					'fields'    => apply_filters(
						...
						[
							// Donation Option.
							[
								'name'        => __( '	Spendenoption', 'give' ),
								'description' => __( 'Möchten Sie, dass dieses Formular einen festen Spendenpreis oder mehrere Ebenen hat (z. B. 10 $, 20 $, 50 $)?', 'give' ),
								...
								'options'     => apply_filters(
									...
									[
										'multi' => __( 'Mehrstufige Spende', 'give' ),
										'set'   => __( 'Spende festlegen', 'give' ),
									]
								),
							],
							[
								'name'          => __( 'Spende festlegen', 'give' ),
								'description'   => __( 'Dies ist der festgelegte Spendenbetrag für dieses Formular. Wenn Sie einen „Benutzerdefinierten Mindestbetrag“ festgelegt haben, stellen Sie sicher, dass dieser unter diesem Betrag liegt.', 'give' ),
								'id'            => $prefix . 'set_price',
							...
							// Custom Amount.
							[
								'name'        => __( 'Benutzerdefinierter Betrag', 'give' ),
								'description' => __( 'Möchten Sie, dass der Benutzer seinen eigenen Spendenbetrag eingeben kann?', 'give' ),
							...
							[
								'name'          => __( 'Spendenlimit', 'give' ),
								'description'   => __( 'Legen Sie den Mindest- und Höchstbetrag für alle Gateways fest.', 'give' ),
								...
								'options'       => [
									'display_label' => __( 'Spendenlimits: ', 'give' ),
							...
							[
								...
								'description'   => __( 'Dieser Text erscheint als Beschriftung unter dem benutzerdefinierten Betragsfeld für festgelegte Spendenformulare. Bei Formularen mit mehreren Ebenen wird der Text als eigene Ebene angezeigt (Schaltfläche, Optionsfeld oder Auswahloption).', 'give' ),
								'id'            => $prefix . 'custom_amount_text',
								'type'          => 'text_medium',
								'default'       => __( 'Benutzerdefinierter Betrag', 'give' ),
								'attributes'    => [
									'rows' => 3,
								],
								'wrapper_class' => 'give-hidden',
							...
							[
								...
								'type'          => 'group',
								'options'       => [
									'add_button'    => __( 'Ebene hinzufügen', 'give' ),
									'header_title'  => __( 'Spendenebene', 'give' ),
								...
								'fields'        => apply_filters(
									...
									[
										...
										[
											...
											'type'       => 'text',
											'attributes' => [
												'placeholder' => __( 'Spendenebene', 'give' ),
												'class' => 'give-multilevel-text-field',
											],
										],
										[
											'name' => __( 'Standard', 'give' ),
											'id'   => $prefix . 'default',
			...
			'form_display_options'  => apply_filters(
				...
				[
					...
					'title'     => __( 'Formularfelder', 'give' ),
					'icon-html' => '<i class="fas fa-stream"></i>',
					'fields'    => apply_filters(
						'give_forms_display_options_metabox_fields',
						[
							[
								'name' => __( 'Standard-Gateway', 'give' ),
								'desc' => __( 'Standardmäßig erbt das Gateway für dieses Formular das globale Standard-Gateway (eingestellt unter Beste Spende > Einstellungen > Zahlungs-Gateways). Mit dieser Option können Sie das Standard-Gateway nur für dieses Formular anpassen.', 'give' ),
								'id'   => $prefix . 'default_gateway',
								'type' => 'default_gateway',
							],
							[
								'name'    => __( 'Namenstitel-Präfix', 'give' ),
								'desc'    => __( 'Möchten Sie vor dem Vornamenfeld des Spenders ein Dropdown-Feld für das Namenstitelpräfix hinzufügen? Daraufhin wird ein Dropdown-Menü mit Optionen wie „Frau“, „Frau“, „Frau“, „Herr“ und „Dr.“ angezeigt, aus denen der Spender auswählen kann.', 'give' ),
							...
							[
								'name'    => __( 'Unternehmensspenden', 'give' ),
								'desc'    => __( 'Möchten Sie, dass nach Vorname und Nachname ein Feld „Firma“ angezeigt wird?', 'give' ),
								'id'      => $prefix . 'company_field',
								'type'    => 'radio_inline',
								'default' => 'global',
								'options' => [
									'global'   => __( 'Globale Option', 'give' ),
									'required' => __( 'Erforderlich', 'give' ),
									'optional' => __( 'Optional', 'give' ),
									'disabled' => __( 'Deaktiviert', 'give' ),
							...
							[
								...
								'desc'    => __( 'Möchten Sie erzwingen, dass das Feld „Nachname“ erforderlich ist?', 'give' ),
							...
							[
								'name'    => __( 'Gastspenden', 'give' ),
								'desc'    => __( 'Möchten Sie nicht eingeloggten Benutzern das Spenden ermöglichen?', 'give' ),
							...
							[
								'name'    => __( 'Anmeldung', 'give' ),
								'desc'    => __( 'Zeigen Sie die Registrierungs- und Anmeldeformulare im Zahlungsbereich für nicht angemeldete Benutzer an.', 'give' ),
								'id'      => $prefix . 'show_register_form',
								'type'    => 'radio',
								'options' => [
									'none'         => __( 'None', 'give' ),
									'registration' => __( 'Anmeldung', 'give' ),
									'login'        => __( 'Login', 'give' ),
									'both'         => __( 'Anmeldung + Login', 'give' ),
								],
								'default' => 'none',
							],
							[
				...
				[
					...
					'fields'    => apply_filters(
						...
						[
							// Goals
							[
								'name'        => __( 'Spendenziel', 'give' ),
								'description' => __( 'Möchten Sie für dieses Formular ein Spendenziel festlegen?', 'give' ),
							...
							[
								'name'        => __( 'Zielformat', 'give' ),
								'description' => __( 'Möchten Sie den gesamten gesammelten Betrag basierend auf Ihrem Geldziel oder einen Prozentsatz anzeigen? Zum Beispiel „500 $ von 1.000 $ gesammelt“ oder „50 % finanziert“ oder „1 von 5 Spenden“. Sie können auch ein spenderbasiertes Ziel anzeigen, z. B. „100 von 1.000 Spendern haben gespendet.“".', 'give' ),
							...
							[
								...
								'name'       => __( 'Spendenziel', 'give' ),
								'desc'       => __( 'Legen Sie die Gesamtzahl der Spenden als Ziel fest.', 'give' ),
								'type'       => 'number',
								'default'    => 1,
								'attributes' => [
									'placeholder' => 1,
							...
							[
								...
								'name'       => __( 'Spenderziel', 'give' ),
								'desc'       => __( 'Legen Sie die Gesamtzahl der Spender als Ziel fest.', 'give' ),
								'type'       => 'number',
								'default'    => 1,
								'attributes' => [
									'placeholder' => 1,
							...
							[
								'name'          => __( 'Farbe des Fortschrittsbalkens', 'give' ),
								'desc'          => __( 'Passen Sie die Farbe des Zielfortschrittsbalkens an.', 'give' ),
							...
							[
								'name'          => __( 'Formular schließen', 'give' ),
								'desc'          => __( 'Möchten Sie die Spendenformulare schließen und keine Spenden mehr annehmen, sobald dieses Ziel erreicht ist?', 'give' ),
							...
							[
								'name'          => __( 'Meldung „Ziel erreicht“.', 'give' ),
								'desc'          => __( 'Möchten Sie eine benutzerdefinierte Nachricht anzeigen, wenn das Ziel geschlossen wird?', 'give' ),
								'id'            => $prefix . 'form_goal_achieved_message',
								'type'          => 'wysiwyg',
								'default'       => __( 'Vielen Dank an alle unsere Spender, wir haben unser Spendenziel erreicht.', 'give' ),
								'wrapper_class' => 'give-hidden',
							],
							[
			...
			'form_terms_options'    => apply_filters(
				...
				[
					...
					'title'     => __( 'Terms & amp; Bedingungen', 'give' ),
					...
					'fields'    => apply_filters(
						...
						[
							...
							[
								...
								'description' => __( 'Möchten Sie, dass der Spender die Bedingungen akzeptiert, bevor er seine Spende abschließen kann?', 'give' ),
							...
							[
								...
								'name'          => __( 'Vereinbarungsetikett', 'give' ),
								'desc'          => __( 'Die Beschriftung wird neben dem Kontrollkästchen „Akzeptiere die Bedingungen“ angezeigt. Fügen Sie Ihre eigenen hinzu, um sie anzupassen, oder lassen Sie das Feld leer, um den Standardtextplatzhalter zu verwenden.', 'give' ),
								'type'          => 'textarea',
								'attributes'    => [
							...
							[
								...
								'desc'          => __( 'Dies ist der eigentliche Text, dem der Benutzer zustimmen muss, um eine Spende zu tätigen.', 'give' ),
							...
							[
								...
								'title' => __( 'Geschäftsbedingungen', 'give' ),
							],
						],
						$post_id
					),
            ...
            'form_grid_options'    => apply_filters(
                ...
                [
                    ...
                    'title'     => __( 'Formulargitter', 'give' ),
                    'icon-html' => '<i class="fas fa-th-large"></i>',
                    'fields'    => [
                        [
                            'name'        => __( 'Form Grid', 'give' ),
                            'description' => __( 'Diese Einstellungen werden verwendet, um anzupassen, wie dieses Formular aussieht oder funktioniert, wenn es als Teil eines Formularrasters angezeigt wird. Die Standardoption besteht darin, dass Spender auf die individuelle Formularseite (oben verlinkt) weitergeleitet werden und „Spenden“ als Standardtext haben. Um dieses Verhalten zu ändern, wählen Sie „Anpassen der Optionen“.', 'give' ),
                            'id'          => $prefix . 'form_grid_option',
                            'type'        => 'radio_inline',
                            'default'     => 'default',
                            'options'     => [
                                'default' => __( 'Standardoptionen', 'give' ),
                        ...
                        [
                            'name'          => __( 'Weiterleitungs-URL', 'give' ),
                            'description'   => __( 'Die vollständige URL der Seite, auf die dieses Formular umgeleitet werden soll, wenn im Formularraster darauf geklickt wird. Dies gilt nur, wenn das Form Grid die Methode „Redirect“ verwendet. ', 'give' ),
                        ...
                        [
                            'name'          => __( 'Schaltflächentext „Spenden“.', 'give' ),
                            'description'   => __( 'Der Text auf der Schaltfläche „Spenden“ für dieses Formular, wenn er im Formularraster angezeigt wird. Diese Einstellung gilt nur, wenn die Anzeigeoption für die Schaltfläche „Spenden“ in Ihrem Formularraster aktiviert ist.', 'give' ),
                            'id'            => $prefix . 'form_grid_donate_button_text',
                            'type'          => 'text-medium',
                            'attributes'    => [
                                'placeholder' => 'Spenden Sie hier',
                                'data-field-visibility' => htmlspecialchars(json_encode([  $prefix . 'form_grid_option' => 'custom' ])),
                            ],
                            'wrapper_class' => 'give-hidden',
                        ],
