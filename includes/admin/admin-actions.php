				...
				case 'delete':
					Give()->notices->register_notice(
						[
							...
							'description' => sprintf(
								_n(
									'Eine Spende wurde erfolgreich gelöscht.',
									'%d Spenden wurden erfolgreich gelöscht.',
									$payment_count,
									'give'
								),
								$payment_count
				...
				case 'resend-receipt':
					Give()->notices->register_notice(
						[
							...
							'description' => sprintf(
								_n(
									'Die E-Mail-Bestätigung wurde erfolgreich an einen Empfänger gesendet.',
									'E-Mail-Bestätigungen wurden erfolgreich an %d Empfänger gesendet.',
									$payment_count,
									'give'
								),
								$payment_count
					...
					case 'donation-deleted':
						Give()->notices->register_notice(
							[
								...
								'type'        => 'updated',
								'description' => __( 'Die Spende wurde gelöscht.', 'give' ),
								'show'        => true,
							]
						);
						break;
					case 'email-sent':
						Give()->notices->register_notice(
							[
								'id'          => 'give-email-sent',
								'type'        => 'updated',
								'description' => __( 'Die Spendenquittung wurde erneut zugesandt.', 'give' ),
								'show'        => true,
							]
						);
						break;
					case 'refreshed-reports':
						Give()->notices->register_notice(
							[
								...
								'type'        => 'updated',
								'description' => __( 'Der Berichtscache wurde geleert.', 'give' ),
								'show'        => true,
							]
						);
						break;
					case 'donation-note-deleted':
						Give()->notices->register_notice(
							[
								...
								'type'        => 'updated',
								'description' => __( 'Der Spendenvermerk wurde gelöscht.', 'give' ),
								'show'        => true,
							]
						);
						break;
					...
					case 'settings-imported':
						Give()->notices->register_notice(
							[
								...
								'type'        => 'updated',
								'description' => __( 'Die Einstellungen wurden importiert.', 'give' ),
								'show'        => true,
							]
						);
						break;
...
function give_license_notices() {
	...
	$notice_description = sprintf(
		_n(
			'Ihr Best Donation-Add-on erhält keine wichtigen Updates und neuen Funktionen, da Sie über den Lizenzschlüssel %1$s verfügen. Bitte <a href="%2$s" title="%3$s">aktivieren Sie Ihre Lizenz</a>, um Updates zu erhalten und <a href="%4$s" target="_blank" title="% 5$s">Prioritärer Support</a>',
