...
if ( ! class_exists( 'Give_Settings_License' ) ) :
	...
	class Give_Settings_License extends Give_Settings_Page {
		...
		public function __construct() {
			$this->id    = 'licenses';
			$this->label = esc_html__( 'Lizenzen', 'give' );
						...
						<div id="give-license-activator-wrap" class="give-license-top-widget">
							<div id="give-license-activator-inner">
								...
								<h2 class="give-license-widget-heading">
									...
									<?php _e( 'Aktivieren Sie eine Add-on-Lizenz', 'give' ); ?>
								</h2>

								<p class="give-field-description">
									<?php
									printf(
										__( 'Enter your license key below to unlock your Best Donation add-ons. You can access your licenses anytime from the Geben Sie unten Ihren Lizenzschlüssel ein, um Ihre Best Donation-Add-ons freizuschalten. Sie können jederzeit über das auf Ihre Lizenzen zugreifen <a href="#" target="_blank">Mein Konto</a> Abschnitt auf der Best Donation-Website. ', 'give' ),
								...
								<form method="post" action="" class="give-license-activation-form">
									...
									<input
										...
										placeholder="<?php _e( 'Gib deinen Lizenz-Schlüssel ein', 'give' ); ?>"
									/>

									<input
										data-activate="<?php _e( 'Lizenz aktivieren', 'give' ); ?>"
										data-activating="<?php _e( 'Lizenz wird überprüft...', 'give' ); ?>"
										value="<?php _e( 'Lizenz aktivieren', 'give' ); ?>"
										type="submit"
						...
						<div id="give-addon-uploader-wrap" class="give-license-top-widget"
							...
							<div id="give-addon-uploader-inner">
								<h2 class="give-license-widget-heading">
									...
									<?php _e( 'Laden Sie ein Add-on hoch und aktivieren Sie es', 'give' ); ?>
								</h2>
								...
								<?php if ( ! is_multisite() ) : ?>
									...
									<p class="give-field-description">
										<?php
										printf(
											__( 'Ziehen Sie eine Add-on-ZIP-Datei nach unten, um sie hochzuladen und zu aktivieren. Greifen Sie auf Ihre Downloads zu, indem Sie eine Lizenz aktivieren oder über <a href="#" target="_blank">Meine Downloads</a> Abschnitt auf der Best Donation-Website.', 'give' ),
									...
									<?php if ( 'direct' !== get_filesystem_method() ) : ?>
										<div class="give-notice notice notice-error inline">
											<p>
												<?php
												echo sprintf(
													__( 'Leider können Sie von hier aus kein Plugin hochladen, da wir keinen direkten Zugriff auf das Dateisystem haben. Bitte<a href="#" target="_blank">klicken Sie hier</a> um das Best Donation Add-on hochzuladen.', 'give' ),
											...
											<form
												...
												<div class="give-activate-addon-wrap">
													...
													<button
														...
														data-activate="<?php _e( 'Add-on aktivieren', 'give' ); ?>"
														data-activating="<?php _e( 'Add-on wird aktiviert...', 'give' ); ?>"
													><?php _e( 'Add-on aktivieren', 'give' ); ?></button>
												</div>

												<?php wp_nonce_field( 'give-upload-addon', '_give_upload_addon' ); ?>

												<p class="give-upload-addon-instructions">
													<?php _e( 'Ziehen Sie eine Plugin-ZIP-Datei hierher, um sie hochzuladen', 'give' ); ?><br>
													<span><?php _e( 'or', 'give' ); ?></span>
												</p>

												<label for="give-upload-addon-file-select" class="button button-small">
													<?php _e( 'Wählen Sie eine Datei aus', 'give' ); ?>
												</label>
												...
												<input
													...
													type="file"
													name="addon"
													value="<?php _e( 'Wählen Sie eine Datei aus', 'give' ); ?>"
												/>
				...
				<div class="give-grid-row<?php echo get_option( 'give_licenses', array() ) ? '' : ' give-hidden'; ?>">
					<div class="give-grid-col-12">
						...
						<div class="give-licenses-list-header give-clearfix">
							<h2><?php _e( 'Lizenzen und Add-ons', 'give' ); ?></h2>
							...
							$button_title     = __( 'Aktualisierungslimit erreicht. Lizenzen können nur 5 Mal pro Tag aktualisiert werden.', 'give' );
							...
							<div id="give-refresh-button-wrap">
								<button id="give-button__refresh-licenses"
										...
										data-activate="<?php _e( 'Alle Lizenzen aktualisieren', 'give' ); ?>"
										data-activating="<?php _e( 'Alle Lizenzen werden aktualisiert...', 'give' ); ?>"
									...
									<?php _e( 'Alle Lizenzen aktualisieren', 'give' ); ?>
								</button>
							...
							<hr>
							<p class="give-field-description"><?php _e( 'In der folgenden Liste werden Ihre Add-ons und deren entsprechende Aktivierungs- und Lizenzstatus angezeigt.', 'give' ); ?></p>
