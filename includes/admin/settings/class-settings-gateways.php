...
if ( ! class_exists( 'Give_Settings_Gateways' ) ) :
	...
	class Give_Settings_Gateways extends Give_Settings_Page {
		...
		public function __construct() {
			$this->id    = 'gateways';
			$this->label = esc_html__( 'Zahlungsgateways', 'give' );
			...
			switch ( $current_section ) {
				case 'offline-donations':
					$settings = [
						...
						[
							'name'    => __( 'Sammeln Sie Rechnungsdetails', 'give' ),
							'desc'    => __( 'Wenn diese Option aktiviert ist, werden den Offline-Spendenformularen erforderliche Felder für die Rechnungsadresse hinzugefügt. Diese Felder sind für die Verarbeitung der Transaktion nicht erforderlich, es kann jedoch sein, dass Sie die Daten erfassen müssen. Details zur Rechnungsadresse werden sowohl zum Spenden- als auch zum Spenderdatensatz in Best Donation hinzugefügt.', 'give' ),
						...
						[
							'name'    => __( 'Anweisungen zur Offline-Spende', 'give' ),
							'desc'    => __( 'Die Offline-Spendenanweisungen bieten Ihnen die Möglichkeit, den Spender darüber aufzuklären, wie er Offline-Spenden am besten einreichen kann. Diese Anweisungen erscheinen direkt auf dem Formular und nach dem Absenden des Formulars. Hinweis: Sie können die Anweisungen auf einzelnen Formularen auch nach Bedarf anpassen.', 'give' ),
						...
						[
							'name'  => esc_html__( 'Link zu den Einstellungen für Offline-Spenden-Dokumente', 'give' ),
							'id'    => 'offline_gateway_settings_docs_link',
							'url'   => esc_url( 'http://Best Donation.com/offlinegateway' ),
							'title' => __( 'Offline-Gateway-Einstellungen', 'give' ),
							'type'  => 'give_docs_link',
						],
						[
							'type' => 'sectionend',
				...
				case 'gateways-settings':
					$settings = [
						...
						[
							'name'    => __( 'Testmodus', 'give' ),
							'desc'    => __( 'Wenn diese Option aktiviert ist, werden Spenden über die Sandbox-/Testkonten verarbeitet, die in den Einstellungen jedes Gateways konfiguriert sind. Dadurch wird vermieden, dass für Tests echtes Geld eingesetzt werden muss. Anweisungen zum Konfigurieren von Sandbox-Konten finden Sie in der Dokumentation zum Zahlungsgateway.', 'give' ),
							'id'      => 'test_mode',
							'type'    => 'radio_inline',
							'default' => 'disabled',
							'options' => [
						...
						[
							'name' => __( 'Ermöglicht Gateways', 'give' ),
			...
			if ( ! $this->hasPremiumPaymentGateway() && ! $this->canAcceptCreditCard() ) {
				...
				<div class="give-gateways-notice">
					...
					<p class="give-gateways-notice-title">
						<strong>
							<?php esc_html_e( 'Möchten Sie Kreditkartenspenden direkt auf Ihrer Website annehmen?', 'give' ); ?>
						</strong>
					</p>
					...
					<p class="give-gateways-notice-message">
						<?php
						printf(
							__( 'Aktivieren Sie das kostenlose Stripe-Zahlungsgateway  %1$s, <a href="%2$s" target="_blank">PayPal-Spenden</a>, oder ein Premium-Gateway wie <a href="%3$s" target="_blank">Authorize.net</a>, or <a href="%4$s" target="_blank">Stripe Premium</a>ohne zusätzliche Gebühren und mit vorrangigem Support.', 'give' ),
							Give()->tooltips->render_help( __( 'Die kostenlose Version von Stripe beinhaltet zusätzlich zu den normalen Stripe-Gebühren für einmalige Spenden eine zusätzliche Bearbeitungsgebühr von 2 %. Dies stellt sicher, dass wir das Plugin auch in Zukunft vollständig unterstützen können. Upgraden Sie ohne zusätzliche Gebühren auf das Premium-Stripe-Add-on.', 'give' ) ),
					...
					<div class="give-gateways-notice-button">
						...
						<a href="#"
						   target="_blank" class="give-view-gateways-btn button">
							<?php esc_html_e( 'Premium-Gateways anzeigen', 'give' ); ?>
						</a>
					</div>
				</div>
				<?php
