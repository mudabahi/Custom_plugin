...
class Give_Donor_Reports_Table extends WP_List_Table {
	...
	public function __construct() {
		...
		parent::__construct(
			array(
				'singular' => esc_html__( 'Spender', 'give' ),     // Singular name of the listed records
				'plural'   => esc_html__( 'Spender', 'give' ),    // Plural name of the listed records
		...
		<div class="tablenav give-clearfix <?php echo esc_attr( $which ); ?>">
			...
			<?php if ( 'top' === $which ) { ?>
				<h2 class="alignleft reports-earnings-title">
					<?php esc_html_e( 'Spenderbericht', 'give' ); ?>
				</h2>
			<?php } ?>
			...
			<div class="alignright tablenav-right">
				<div class="actions bulkactions">
					<?php
					if ( 'top' === $which ) {
						$this->give_search_box( esc_html__( 'Spender suchen', 'give' ), 'give-donors-report-search' );
					}
