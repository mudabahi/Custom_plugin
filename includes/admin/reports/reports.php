...
function give_reports_default_views() {
	$views = [
		'earnings' => esc_html__( 'Einnahmen', 'give' ),
		'forms'    => esc_html__( 'Formen', 'give' ),
		'gateways' => esc_html__( 'Spendenmethoden	', 'give' ),
	];
...
function give_reports_tab_reports() {
	...
	if ( ! current_user_can( 'view_give_reports' ) ) {
		wp_die( __( 'Sie haben keine Berechtigung, auf diesen Bericht zuzugreifen', 'give' ), __( 'Error', 'give' ), [ 'response' => 403 ] );
	}
