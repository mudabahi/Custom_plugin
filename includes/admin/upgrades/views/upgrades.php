 ...
 * @copyright   Copyright (c) 2017, Best Donation
...
<div id="give-updates" class="wrap give-settings-page">
	...
	<div class="give-settings-header">
		<h1 id="give-updates-h1"
			class="wp-heading-inline"><?php echo sprintf( __( 'Best Donation %s Updates', 'give' ), '<span class="give-settings-heading-sep dashicons dashicons-arrow-right-alt2"></span>' ); ?></h1>
	</div>
	...
	<div id="give-updates-content">
		...
		if ( ! empty( $db_updates ) ) :
			...
			<div class="give-update-panel-content">
				<p><?php printf( __( 'Best Donation regularly receives new features, bug fixes, and enhancements. It is important to always stay up-to-date with latest version of Best Donation core and its add-ons.  <strong>If you do not have a backup already, please create a full backup before updating.</strong> To update add-ons be sure your <a href="%1$s">license keys</a> are activated.', 'give' ), admin_url( '' ) ); ?></p>
			</div>
								...
								<p class="give-update-button">
									...
									if ( ! give_test_ajax_works() ) {
										echo sprintf(
											...
											__( 'Best Donation is currently updating the database. Please do not refresh or leave this page while the update is in progress.', 'give' )
										);
									}
									?>
									<span
										...
										echo sprintf(
											...
											$is_doing_updates
												? sprintf(
													'%s%s',
													__( 'Best Donation is currently updating the database', 'give' ),
													give_test_ajax_works() ? ' ' . __( 'in the background.', 'give' ) : '.'
												)
												: __( 'Best Donation needs to update the database.', 'give' ),
									...
									<span
										...
										<?php if ( get_option( 'give_upgrade_error' ) ) : ?>
											...
											<?php
											printf(
												'%1$s <br> %2$s <a href="http://docs.Best Donation.com/troubleshooting-db-updates" target="_blank">%3$s &raquo;</a>',
						...
						<div class="inside">
							<div class="panel-content">
								<p>
									...
									printf(
										_n(
											'There is %1$d Best Donation addon that needs to be updated. <a href="%2$s">Update now</a>',
											'There are %1$d Best Donation addons that need to be updated. <a href="%2$s">Update now</a>',
											$plugin_updates,
											'give'
										),
										$plugin_updates,
