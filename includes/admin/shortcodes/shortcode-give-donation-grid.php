...
class Give_Shortcode_Donation_Grid extends Give_Shortcode_Generator {
	...
	public function __construct() {
		...
		$this->shortcode['title'] = esc_html__( 'Spendenformular-Raster', 'give' );
		$this->shortcode['label'] = esc_html__( 'Spendenformular-Raster', 'give' );
	...
	public function define_fields() {
		...
		return array(
			...
			array(
				'type' => 'docs_link',
				'text' => esc_html__( 'Learn more about the Spendenformular-Raster Shortcode', 'give' ),
