...
class Give_Addon_Activation_Banner {
	 ...
	 *                               'documentation_url' => 'http://docs.#.com/addon-authorize',// (required)
	 *                               'support_url'       => 'https://Best Donation.com/support/', // (required)Location of Add-on settings page, leave blank to hide
	...
	private function render_single_addon_banner( $banner_arr, $is_single ) {
		...
		?>
		<!-- Logo Chance -->
		<img src="<?php echo esc_url( GIVE_PLUGIN_URL . 'assets/dist/images/best-icon-full-circle.svg' ); ?>" class="give-logo" />
		<div class="give-alert-message">
			<h3>
				...
				printf(
					...
					'%s<span>%s</span>',
					__( 'New Best Donation Add-on Activated: ', 'give' ),
