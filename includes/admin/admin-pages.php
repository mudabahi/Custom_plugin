...
function give_add_settings_subpage()
{
    ...
    $give_settings_page = add_submenu_page(
        'edit.php?post_type=give_forms',
        esc_html__('Beste Spendeneinstellungen', 'give'),
        esc_html__('Einstellungen', 'give'),
...
function give_add_tools_subpage()
{
    ...
    $give_tools_page = add_submenu_page(
        'edit.php?post_type=give_forms',
        esc_html__('Beste Spendentools', 'give'),
        esc_html__('Werkzeuge', 'give'),
        'manage_give_settings',
        'give-tools',
        [
            Give()->give_settings,
