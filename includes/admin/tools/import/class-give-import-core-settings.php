		...
		public function render_upload_html() {
			...
			<tr valign="top">
				<th colspan="2">
					...
					<p class="give-field-description"><?php esc_html_e( 'This tool allows you to import Best Donation settings from another Best Donation installation. Settings imported contain data from Best Donation core as well as any of our Premium Add-ons.', 'give' ); ?></p>
				</th>
			</tr>
