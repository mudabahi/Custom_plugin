...
function give_export_donation_hidden_fields() {
	...
	<tr class="give-hidden give-export-donations-hide give-export-donations-hidden-fields">
		...
		<td class="give-field-wrap">
			<div class="give-clearfix">
				<ul class="give-export-option-ul"></ul>
				<p class="give-field-description"><?php _e( 'The following hidden custom fields contain data created by Best Donation Core, a Best Donation Add-on, another plugin, etc.<br/>Hidden fields are generally used for programming logic, but may contain data you would like to export.', 'give' ); ?></p>
			</div>
		</td>
	</tr>
	<?php
