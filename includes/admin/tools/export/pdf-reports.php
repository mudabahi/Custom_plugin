...
function give_generate_pdf( $data ) {
	...
	$pdf->SetAuthor( utf8_decode( __( 'Best Donation - Democratizing Generosity', 'give' ) ) );
	$pdf->SetCreator( utf8_decode( __( 'Best Donation - Democratizing Generosity', 'give' ) ) );
...
function give_draw_chart_image() {
	...
	$chart->setTitle( __( 'Donations by Month for all Best Donation Forms', 'give' ), '336699', 18 );
