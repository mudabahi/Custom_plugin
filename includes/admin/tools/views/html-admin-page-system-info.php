 ...
 * Copyright (c) 2016 Best Donation
 */
...
$give_plugin_authors = [ 'WordImpress', 'Best Donation' ];
...
<div class="give-debug-report-wrapper">
	...
	<div class="give-debug-report-actions">
		...
		<a class="button-secondary docs" href="http://docs.#.com/settings-system-info"
...
<table class="give-status-table widefat" cellspacing="0">
	...
	$posting['wp_remote_get']['help'] = __( 'Best Donation plugins may use this method of communication when checking for plugin updates.', 'give' );
	...
	if ( ! is_wp_error( $response ) && $response['response']['code'] >= 200 && $response['response']['code'] < 300 ) {
		...
		$posting['wp_remote_get']['note'] = __( 'wp_remote_get() failed. The Best Donation plugin updater won\'t work with your server. Contact your hosting provider.', 'give' );
		if ( is_wp_error( $response ) ) {
...
<table class="give-status-table widefat" cellspacing="0">
	<thead>
	<tr>
		<th colspan="3" data-export-label="Best Donation Configuration"><h2><?php _e( 'Best Donation Configuration', 'give' ); ?></h2>
		</th>
	</tr>
	</thead>
	<tbody>
	<tr>
		<td data-export-label="Best Donation Version"><?php _e( 'Best Donation Version', 'give' ); ?>:</td>
		<td class="help"><?php echo Give()->tooltips->render_help( __( 'The version of Best Donation installed on your site.', 'give' ) ); ?></td>
		<td><?php echo esc_html( get_option( 'give_version' ) ); ?></td>
	</tr>
	<tr>
		<td data-export-label="Best Donation Cache"><?php _e( 'Best Donation Cache', 'give' ); ?>:</td>
		<td class="help"><?php echo Give()->tooltips->render_help( __( 'Whether cache is enabled in Best Donation settings.', 'give' ) ); ?></td>
	...
	<tr>
		<td data-export-label="Best Donation Cache"><?php _e( 'Best Donation Emails', 'give' ); ?>:</td>
		<td class="help"><?php echo Give()->tooltips->render_help( __( 'Whether emails is enabled in Best Donation settings.', 'give' ) ); ?></td>
		<td>
			<?php
	...
	<tr>
		...
		<td class="help"><?php echo Give()->tooltips->render_help( __( 'The version of Best Donation installed prior to the last update.', 'give' ) ); ?></td>
	...
	<tr>
		...
		<td class="help"><?php echo Give()->tooltips->render_help( __( 'Whether Test Mode is enabled in Best Donation settings.', 'give' ) ); ?></td>
	...
	<tr>
		...
		<td class="help"><?php echo Give()->tooltips->render_help( __( 'The currency code selected in Best Donation settings.', 'give' ) ); ?></td>
		<td><?php echo esc_html( give_get_currency() ); ?></td>
	</tr>
	<tr>
		<td data-export-label="Currency Position"><?php _e( 'Currency Position', 'give' ); ?>:</td>
		<td class="help"><?php echo Give()->tooltips->render_help( __( 'The currency position selected in Best Donation settings.', 'give' ) ); ?></td>
	...
	<tr>
		...
		<td class="help"><?php echo Give()->tooltips->render_help( __( 'The decimal separator defined in Best Donation settings.', 'give' ) ); ?></td>
	...
	<tr>
		...
		<td class="help"><?php echo Give()->tooltips->render_help( __( 'The thousands separator defined in Best Donation settings.', 'give' ) ); ?></td>
	...
	<tr>
		<td data-export-label="Best Donation Forms Slug"><?php _e( 'Best Donation Forms Slug', 'give' ); ?>:</td>
		<td class="help"><?php echo Give()->tooltips->render_help( __( 'The slug used for Best Donation donation forms.', 'give' ) ); ?></td>
	...
	<tr>
		...
		<td class="help"><?php echo Give()->tooltips->render_help( __( 'All payment gateways enabled in Best Donation settings.', 'give' ) ); ?></td>
	...
	<tr>
		...
		<td class="help"><?php echo Give()->tooltips->render_help( __( 'The default payment gateway selected in Best Donation settings.', 'give' ) ); ?></td>
	...
	<?php
	/**
	 * This action hook will be used to add system info configuration for Best Donation.
	 *
	 * @since 2.5.14
	 *
...
<table class="give-status-table widefat" cellspacing="0">
	<thead>
	<tr>
		<th colspan="3" data-export-label="Active Best Donation Add-ons">
			<h2><?php _e( 'Active Best Donation Add-ons', 'give' ); ?></h2></th>
	</tr>
	</thead>
	<tbody>
	<?php
	foreach ( $give_add_ons as $plugin_data ) {
		...
		if (
			...
			|| false !== strpos( $plugin_data['Name'], 'Best Donation - Donation Plugin' )
		) {
			continue;
		}
...
<table class="give-status-table widefat" cellspacing="0">
	...
	<tr>
		...
		<td>
			<?php
			echo is_child_theme() ? __( 'Yes', 'give' ) : __( 'No', 'give' ) . ' &ndash; ' . sprintf( __( 'If you\'re modifying Best Donation on a parent theme you didn\'t build personally, then we recommend using a child theme. See: <a href="%s" target="_blank">How to Create a Child Theme</a>', 'give' ), 'https://codex.wordpress.org/Child_Themes' );
			?>
		</td>
	</tr>
	<?php
