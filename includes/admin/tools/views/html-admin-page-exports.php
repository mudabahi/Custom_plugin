		...
		<div id="post-body">
			<div id="post-body-content">
				...
				<table class="widefat export-options-table give-table striped">
					<thead>
					<tr>
						<th scope="col"><?php esc_html_e( 'Exporttyp', 'give' ); ?></th>
						<th scope="col"><?php esc_html_e( 'Exportoptionen', 'give' ); ?></th>
					</tr>
					</thead>
					<tbody>
					<?php
					...
					<tr class="give-export-donations-history">
						<td scope="row" class="row-title">
							<h3>
								<span><?php esc_html_e( 'Spendenhistorie exportieren', 'give' ); ?></span>
							</h3>
							<p><?php esc_html_e( 'Laden Sie eine CSV-Datei aller erfassten Spenden herunter.', 'give' ); ?></p>
						</td>
						<td>
							<a class="button" href="<?php echo esc_url( add_query_arg( [ 'type' => 'export_donations' ] ) ); ?>">
								<?php esc_html_e( 'CSV generieren', 'give' ); ?>
							</a>
						</td>
					</tr>
					...
					<tr class="give-export-pdf-sales-earnings">
						<td scope="row" class="row-title">
							<h3>
								<span><?php esc_html_e( 'Exportieren Sie Spenden und Einnahmen als PDF', 'give' ); ?></span>
							</h3>
							<p><?php esc_html_e( 'Laden Sie ein PDF mit Spenden- und Einnahmenberichten für alle Formulare für das laufende Jahr herunter.', 'give' ); ?></p>
						</td>
						<td>
					...
					<tr class="give-export-sales-earnings">
						<td scope="row" class="row-title">
							<h3>
								<span><?php esc_html_e( 'Statistiken zu Exporteinnahmen und Spenden', 'give' ); ?></span>
							</h3>
							<p><?php esc_html_e( 'Laden Sie eine CSV-Datei mit Einnahmen und Spenden im Laufe der Zeit herunter.', 'give' ); ?></p>
						</td>
						<td>
							<form method="post">
                                <?php
								...
								<input type="submit" value="<?php esc_attr_e( 'CSV generieren', 'give' ); ?>" class="button-secondary"/>
							</form>
						</td>
					</tr>
					...
					<tr class="give-export-core-settings">
						<td scope="row" class="row-title">
							...
							<p><?php esc_html_e( 'Laden Sie einen Export der besten Spendeneinstellungen herunter und importieren Sie ihn in eine neue WordPress-Installation.', 'give' ); ?></p>
						</td>
						<td>
							<form method="post">
								<?php
								...
								if ( ! empty( $export_excludes ) ) {
									?>
									<i class="settings-excludes-title"><?php esc_html_e( 'Markierte Optionen aus der Liste werden nicht exportiert.', 'give' ); ?></i>
								...
								<input type="submit" value="<?php esc_attr_e( 'JSON exportieren', 'give' ); ?>" class="button-secondary"/>
							</form>
						</td>
					</tr>
					<?php
