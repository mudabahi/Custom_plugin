...
const donationStatus = [
  ...
  {
    value: "publish",
    text: __("Veröffentlicht", "give"),
  },
  {
    value: "pending",
    text: __("Ausstehend", "give"),
  },
  {
    value: "draft",
    text: __("Entwurf", "give"),
  },
  {
    value: "trash",
    text: __("Müll", "give"),
...
const donationFormsFilters: Array<FilterConfig> = [
  {
    name: "search",
    type: "search",
    text: __("Suche nach Name oder ID", "give"),
    ariaLabel: __("Search Spendenformulare", "give"),
  },
  {
    name: "status",
    type: "select",
    text: __("status", "give"),
    ariaLabel: __("Spendenformulare nach Status filtern", "give"),
...
const donationFormsBulkActions: Array<BulkActionsConfig> = [
  {
    ...
    confirm: (selected, names) => (
      <>
        <p>Spendenformulare to be edited:</p>
  ...
  },
  {
    ...
    confirm: (selected, names) => (
      <div>
        <p>{__("Really delete the following Spendenformulare?", "give")}</p>
        <ul role="document" tabIndex={0}>
          {selected.map((id, index) => (
            <li key={id}>
              <Interweave content={names[index]} />
  ...
  },
  {
    ...
    confirm: (selected, names) => (
      <div>
        <p>{__("Really trash the following Spendenformulare?", "give")}</p>
        <ul role="document" tabIndex={0}>
          {selected.map((id, index) => (
            <li key={id}>
              <Interweave content={names[index]} />
...
export default function DonationFormsListTable() {
  return (
    <ListTablePage
      title={__("Spendenformulare ", "give")}
      singleName={__("donation form", "give")}
      pluralName={__("Spendenformulare", "give")}
