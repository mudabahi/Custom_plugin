...
class DonationFormsAdminPage
{
    ...
    public function register()
    {
        ...
        add_submenu_page(
            ...
            esc_html__('Spendenformulare', 'give'),
            esc_html__('Spendenformulare', 'give'),
            'edit_give_forms',
            'give-forms',
            [$this, 'render'],
    ...
    /**
     * Display a button on the old Spendenformulare table that switches to the React view
     *
     * @since 2.20.0
     */
    ...
    /**
     * Helper function to determine if the current page is the legacy Spendenformulare list page
     *
     * @since 2.20.1
     */
