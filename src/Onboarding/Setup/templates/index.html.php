<div class="wrap" class="give-setup-page">
    ...
    <h1 class="wp-heading-inline">
        <?php
        echo __('Best Donation Setup Guide', 'give'); ?>
    </h1>
                ...
                [
                    ...
                    'action' => $this->render_template(
                        ...
                        [
                            ...
                            'screenReaderText' => 'Configure Best Donation',
                        ]
                    ),
                ]
            ),
        ...
        [
            ...
            'footer' => $this->render_template(
                ...
                [
                    'contents' => sprintf(
                        __(
                            'Want to use a different gateway? Best Donation has support for many others including Authorize.net, Square, Razorpay and more! %s',
                            'give'
                        ),
                        sprintf(
                            '<a href="%s" target="_blank">%s <i class="fa fa-chevron-right" aria-hidden="true"></i></a>',
                            'Best Donation.com/payment-gateways', // UTM included.
            ...
            'contents' => [
                ...
                in_array('recurring-donations', $settings['addons']) ? $this->render_template(
                    ...
                    [
                        ...
                        'action' => $this->render_template(
                            ...
                            [
                                'target' => '_blank',
                                'href' => 'Best Donation.com/setup-recurring', // UTM included.
                ...
                in_array('donors-cover-fees', $settings['addons']) ? $this->render_template(
                    ...
                    [
                        ...
                        'action' => $this->render_template(
                            ...
                            [
                                'target' => '_blank',
                                'href' => 'Best Donation.com/setup-fee-recovery', // UTM included.
                ...
                in_array('pdf-receipts', $settings['addons']) ? $this->render_template(
                    ...
                    [
                        ...
                        'action' => $this->render_template(
                            ...
                            [
                                'target' => '_blank',
                                'href' => 'Best Donation.com/setup-pdf-receipts', // UTM included.
                ...
                in_array('custom-form-fields', $settings['addons']) ? $this->render_template(
                    ...
                    [
                        ...
                        'description' => __(
                            'Form Field Manager (FFM) allows you to add and manage additional fields for your Best Donation donation forms using an intuitive drag-and-drop interface. Form fields include simple fields such as checkboxes, dropdowns, radios, and more. The more complex form fields that you can add are file upload fields, Rich text editors (TinyMCE), and the powerful Repeater field.',
                            'give'
                        ),
                        'action' => $this->render_template(
                            'action-link',
                            [
                                'target' => '_blank',
                                'href' => 'Best Donation.com/setup-ffm', // UTM included.
                ...
                in_array('multiple-currencies', $settings['addons']) ? $this->render_template(
                    ...
                    [
                        ...
                        'description' => __(
                            'Allow your donors to switch to their currency of choice and increase your overall giving with the Best Donation Currency Switcher add-on. Select from an extensive list of currencies, set the currency based on your donor\'s location, pull from live exchange rates and more!',
                            'give'
                        ),
                        'action' => $this->render_template(
                            'action-link',
                            [
                                'target' => '_blank',
                                'href' => 'Best Donation.com/setup-currency-switcher', // UTM included.
                ...
                in_array('dedicate-donations', $settings['addons']) ? $this->render_template(
                    ...
                    [
                        ...
                        'action' => $this->render_template(
                            ...
                            [
                                'target' => '_blank',
                                'href' => 'Best Donation.com/setup-tributes', // UTM included.
                ...
                $this->render_template(
                    ...
                    [
                        ...
                        'title' => esc_html__('Best Donation Add-ons', 'give'),
                        'description' => esc_html__(
                        ...
                        'action' => $this->render_template(
                            ...
                            [
                                'target' => '_blank',
                                'href' => 'Best Donation.com/setup-addons', // UTM included.
                                'screenReaderText' => __('View Add-ons for Best Donation', 'give'),
                            ]
                        ),
                    ]
                ),
    ...
    echo $this->render_template(
        'section',
        [
            'title' => __('Get the most out of Best Donation', 'give'),
            'contents' => [
                $this->render_template(
                    'row-item',
                    [
                        ...
                        'icon_alt' => esc_html__('Best Donation Getting Started Guide', 'give'),
                        'title' => esc_html__('Best Donation Getting Started Guide', 'give'),
                        'description' => esc_html__(
                        ...
                        'action' => $this->render_template(
                            ...
                            [
                                'target' => '_blank',
                                'href' => 'Best Donation.com/getting-started', // UTM included.
                                'screenReaderText' => __('Learn more about Best Donation', 'give'),
                            ]
                        ),
                    ]
                ),
