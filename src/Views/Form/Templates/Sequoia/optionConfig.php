    ...
    'thank-you' => [
        ...
        'fields' => [
            ...
            [
                ...
                'name' => __('Description', 'give'),
                'desc' => __(
                    'The description is displayed directly below the main headline and should be 1-2 sentences. You may use <a href="http://docs.#.com/email-tags" target="_blank">any of the available template tags</a> within this message.',
                    'give'
                ),
                'type' => 'wysiwyg',
                'attributes' => [
