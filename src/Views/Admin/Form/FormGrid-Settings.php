<!-- <div class="form_grid_options_wrap inner-panel">
    <div class="form-template-introduction">
        ...
        <div class="form-template-notice">
            ...
            <p>
                <?php _e('Was ist das Formularraster?', 'give'); ?><br />
                <?php _e('Das Best Donation Form Grid bietet eine Möglichkeit, mithilfe eines Blocks oder eines Shortcodes ein Rasterlayout mehrerer Formulare in Beiträge und Seiten einzufügen.', 'give'); ?>
            </p>
