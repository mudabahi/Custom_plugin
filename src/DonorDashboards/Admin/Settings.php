...
class Settings
{
    ...
    protected function getDonorDashboardPageSetting()
    {
        ...
        return [
            ...
            'desc' => __(
                          'This is the page where donors can manage their information, review history and more -- all in one place. The Donor Dashboard block or <code>[best_donor_dashboard]</code> shortcode should be on this page. ',
                          'give'
